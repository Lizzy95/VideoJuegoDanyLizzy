...
public class SoundClip {
	...
	private AudioInputStream sample; //crea sonido
	private Clip clip;
	private boolean looping = false; // para seguir un sonido
	private int repeat = 0; // veces que se repetira un sonido
